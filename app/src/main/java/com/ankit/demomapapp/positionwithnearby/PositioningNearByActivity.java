...
package com.ankit.demomapapp.positionwithnearby;
...
public class PositioningNearByActivity extends Activity implements PositioningManager.OnPositionChangedListener, Map.OnTransformListener {
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        inflater.inflate(R.menu.activity_basic_positioning, menu);
        return true;
    }
    ...
    private MapFragment getMapFragment() {
        return (MapFragment)getFragmentManager().findFragmentById(R.id.basic_position_mapfragment);
    }
    ...
    private void initializeMapsAndPositioning() {
        setContentView(R.layout.positioning_activity_basic);
            ...
            mapFragment.init(new OnEngineInitListener() {
                ...
                public void onEngineInitializationCompleted(Error error) {
                    if (error == Error.NONE) {
                        ...
                        map.addTransformListener(PositioningNearByActivity.this);
                        ...
                        if (mHereLocation == null) {
                            Toast.makeText(PositioningNearByActivity.this, "LocationDataSourceHERE.getInstance(): failed, exiting", Toast.LENGTH_LONG).show();
                            finish();
                        }
                        ...
                        mPositioningManager.addListener(new WeakReference<PositioningManager.OnPositionChangedListener>(
                                PositioningNearByActivity.this));
                        ...
                        if (mPositioningManager.start(PositioningManager.LocationMethod.GPS_NETWORK_INDOOR)) {
                            ...
                            Toast.makeText(PositioningNearByActivity.this, "PositioningManager.start: failed, exiting", Toast.LENGTH_LONG).show();
                            finish();
                        }
                    } else {
                        Toast.makeText(PositioningNearByActivity.this, "onEngineInitializationCompleted: error: " + error + ", exiting", Toast.LENGTH_LONG).show();
                        finish();
                    }
                }
            });
            ...
            .setItems(names, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        ...
                        Toast.makeText(PositioningNearByActivity.this, "setLocationMethod failed: "
            ...
            .setItems(names, new DialogInterface.OnClickListener() {
                ...
                public void onClick(DialogInterface dialog, int which) {
                    try {
                        ...
                        Toast.makeText(PositioningNearByActivity.this, "setIndoorMode failed: "
                                + ex.getMessage(), Toast.LENGTH_LONG).show();
                    } finally {
                        dialog.dismiss();
                    }
    ...
    private void setLocationMethod(PositioningManager.LocationMethod method) {
        if (!mPositioningManager.start(method)) {
            Toast.makeText(PositioningNearByActivity.this, "PositioningManager.start(" + method + "): failed", Toast.LENGTH_LONG).show();
        }
    }
    ...
    private void setIndoorMode(LocationDataSourceHERE.IndoorPositioningMode mode) {
        ...
        case FEATURE_NOT_LICENSED:
            Toast.makeText(PositioningNearByActivity.this, mode + ": is not licensed", Toast.LENGTH_LONG).show();
            break;
        case INTERNAL_ERROR:
            Toast.makeText(PositioningNearByActivity.this, mode + ": internal error", Toast.LENGTH_LONG).show();
            break;
        case MODE_NOT_ALLOWED:
            Toast.makeText(PositioningNearByActivity.this, mode + ": is not allowed", Toast.LENGTH_LONG).show();
            break;
        case PENDING:
        case OK:
        default:

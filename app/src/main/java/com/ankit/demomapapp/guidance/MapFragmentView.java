...
package com.ankit.demomapapp.guidance;
...
public class MapFragmentView implements LocationListener{
    ...
    public MapFragmentView(Activity activity) {
        ...
        if (locationManager != null) {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, Long.valueOf(0), 0.0f, com.ankit.demomapapp.guidance.MapFragmentView.this);
        }

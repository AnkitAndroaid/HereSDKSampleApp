...
public class HomeActivity extends AppCompatActivity implements  GoogleApiClient.ConnectionCallbacks,
    ...
    Button simpleMap, currentPos, aroundMe, navigation,simulation;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        simulation = findViewById(R.id.button5);
        setUpGClient();
        ...
        simulation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                startActivity(new Intent(HomeActivity.this, com.ankit.demomapapp.guidance.MainActivity.class ));
            }
        });
...
//                            .requestLocationUpdates(googleApiClient,locationRequest, HomeActivity.this);

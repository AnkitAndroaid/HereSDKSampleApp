...
public class MapFragmentView implements LocationListener {
    ...
    public MapFragmentView(Activity activity, Context context) {
        ...
        if (locationManager != null) {
            ...
            locationManager.requestLocationUpdates(LocationManager.GPS_PROVIDER, Long.valueOf(0), 0.0f, MapFragmentView.this);
        }
                ...
                m_mapFragment.init(new OnEngineInitListener() {
                    ...
                    public void onEngineInitializationCompleted(Error error) {
                        if (error == Error.NONE) {
                            ...
                            m_map.setCenter(new GeoCoordinate(lati, longi),
                                    Map.Animation.NONE);
